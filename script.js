 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "  const recipientAddress = '0xRECIPIENT_ADDRESS_HERE'; // Replace with the recipient's address\n",
    "  const transferAmount = web3.utils.toWei('1', 'ether'); // Replace '1' with the desired transfer amount in Ether\n",
    "\n",
    "  // Check the sender's balance\n",
    "  const balance = await web3.eth.getBalance(yourAddress);\n",
    "  console.log(`Your balance: ${web3.utils.fromWei(balance, 'ether')} Ether`);\n",
    "\n",
    ...
    "\n",
    "  try {\n",
    "    const gasEstimate = await contractInstance.methods.transfer(recipientAddress, transferAmount).estimateGas({from: yourAddress});\n",
    "    console.log(`Estimated gas: ${gasEstimate}`);\n",
    "\n",
    "    const gasPrice = await web3.eth.getGasPrice();\n",
    "    console.log(`Current gas price: ${gasPrice}`);\n",
    "\n",
    "    const transferFunction = contractInstance.methods.transfer(recipientAddress, transferAmount);\n",
    "\n",
    "    const txData = {\n",
    "      from: yourAddress,\n",
    "      to: contractAddress,\n",
    ...
    "    });\n",
    "  } catch (error) {\n",
    "    console.error('Error signing and sending the transaction:', error);\n",
    "  }\n",
    "})();"
   ]
  }
