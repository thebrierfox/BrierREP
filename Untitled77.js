 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "c977cd00-99fc-4bbe-a79a-6d4e4736c0e9",
   "metadata": {
    "tags": []
   },
   "outputs": [],
   "source": [
    ...
    "    data.ta.ema(length=short_ma, append=True)\n",
    "    data.ta.ema(length=long_ma, append=True)\n",
    "    return data\n",
    "\n",
    ...
    "    signals = {}\n",
    "    signals[\"long\"] = data[\"EMA_12\"].iloc[-1] > data[\"EMA_26\"].iloc[-1] and data[\"EMA_12\"].iloc[-2] <= data[\"EMA_26\"].iloc[-2]\n",
    "    signals[\"short\"] = data[\"EMA_12\"].iloc[-1] < data[\"EMA_26\"].iloc[-1] and data[\"EMA_12\"].iloc[-2] >= data[\"EMA_26\"].iloc[-2]\n",
    "    return signals\n",
    "\n",
    ...
    "        trade_amount = balance * 0.1  # Use 10% of available BTC balance for each trade\n",
  ...
  },
  {
   ...
   "id": "84e972f4-3eaa-4a95-b415-d3719309e415",
   "metadata": {},
   "outputs": [],
   "source": []
  }
